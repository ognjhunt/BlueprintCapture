...
import { buildCaptureBundleReferences, buildPoseIndex, chooseKeyframeCandidate, evaluateClaimedArtifacts, evaluateQualityGate, findClosestPoseByTime, parsePoseRows, } from "./bridge.js";
...
test("buildCaptureBundleReferences only emits URIs for valid artifacts", () => {
    ...
    assert.equal(captureBundle.arkit_poses_uri, "gs://bucket/scenes/scene/captures/capture/raw/arkit/poses.jsonl");
    assert.equal(captureBundle.arkit_intrinsics_uri, undefined);
    assert.equal(captureBundle.arkit_depth_prefix_uri, "gs://bucket/scenes/scene/captures/capture/raw/arkit/depth");
