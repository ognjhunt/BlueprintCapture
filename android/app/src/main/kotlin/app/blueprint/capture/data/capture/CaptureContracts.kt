...
data class CaptureEvidence(
    ...
    @SerialName("geospatial_rows") val geospatialRows: Int = 0,
    ...
    @SerialName("geospatial_authority") val geospatialAuthority: CaptureAuthority = CaptureAuthority.NotAvailable,
